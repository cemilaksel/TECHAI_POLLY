// Paul Nation's Essential English Words - Romanian High-Frequency Translation List
export const ESSENTIAL_WORDS_RO = [
  // --- BOOK 1 ---
  "frică", "de acord", "supărat", "a sosi", "atac", "fund", "deștept", "crud", "în sfârșit", "a ascunde", 
  "a vâna", "mult", "mijloc", "moment", "mulțumit", "promisiune", "răspuns", "sigur", "truc", "bine",
  "aventură", "abordare", "cu grijă", "chimic", "a crea", "rău", "experiment", "a ucide", "laborator",
  "râs", "tare", "nervos", "zgomot", "proiect", "a speria", "secret", "a striga", "miros", "groaznic", "mai rău",
  "extraterestru", "printre", "tabel", "nor", "a înțelege", "a descrie", "vreodată", "a eșua", "prietenos", "notă",
  "în loc de", "bibliotecă", "planetă", "raport", "mai mulți", "a rezolva", "deodată", "a presupune", "univers", "vedere",
  "adecvat", "a evita", "a se comporta", "calm", "îngrijorare", "mulțumit", "a se aștepta", "frecvent", "obicei", "a instrui",
  "problemă", "niciunul", "răbdător", "pozitiv", "a pedepsi", "a reprezenta", "a tremura", "a răspândi", "plimbare", "sat",
  "conștient", "rău", "a aparține", "a continua", "eroare", "experiență", "câmp", "a răni", "judecată", "probabil",
  "normal", "rar", "a se relaxa", "cerere", "a locui", "rezultat", "a rula", "de când", "vizibil", "sălbatic",
  "avantaj", "cauză", "alegere", "comunitate", "mort", "distanță", "evadare", "față", "a urma",
  "frică", "fantomă", "individual", "animal de companie", "a ajunge la", "a se întoarce", "a supraviețui", "supărat", "voce", "vreme", "înțelept",
  "a permite", "a anunța", "lângă", "provocare", "a pretinde", "condiție", "a contribui", "diferență", "a împărți",
  "expert", "faimos", "forță", "daună", "a așeza", "pace", "prinț", "a proteja", "simț", "brusc", "deci",
  "a accepta", "a aranja", "a participa", "echilibru", "contrast", "a încuraja", "familiar", "a înfăca", "a atârna", "uriaș",
  "necesar", "model", "a propune", "scop", "eliberare", "a necesita", "singur", "succes", "lacrimă", "teorie",
  "împotriva", "plajă", "daună", "a descoperi", "emoție", "a repara", "sincer", "a identifica", "insulă", "ocean",
  "poate", "plăcut", "a preveni", "stâncă", "a salva", "pas", "încă", "gust", "a arunca", "val",
  "beneficiu", "sigur", "șansă", "efect", "esențial", "departe", "focus", "funcție", "iarbă", "pază",
  "imagine", "imediat", "primar", "mândru", "a rămâne", "odihnă", "separat", "loc", "coadă", "problemă",
  "nu mai", "adormit", "bacă", "a colecta", "a concura", "conversație", "creatură", "decizie", "fie",
  "pădure", "pământ", "a prezenta", "a se căsători", "a pregăti", "a naviga", "serios", "a cheltui", "ciudat", "adevăr", "a se trezi",
  "singur", "apartament", "articol", "artist", "atitudine", "a compara", "a judeca", "revistă", "material", "masă",
  "metodă", "vecin", "profesionist", "profit", "quality", "formă", "spațiu", "treaptă", "simbol", "subțire",
  "sânge", "a arde", "celulă", "a conține", "corect", "recoltă", "cerere", "egal", "a hrăni", "gaură", "creștere",
  "domn", "a datora", "poziție", "a ridica", "responsabil", "vedere", "pată", "structură", "întreg",
  "antrenor", "control", "descriere", "direct", "examen", "exemplu", "limită", "local", "magic", "poștă",
  "roman", "contur", "poet", "a printa", "scenă", "foaie", "prostesc", "magazin", "a suferi", "tehnologie",
  "peste", "a respira", "caracteristică", "a consuma", "a excita", "extrem", "frică", "norocos", "a se întâmpla",
  "lungime", "greșeală", "a observa", "oportunitate", "premiu", "cursă", "a realiza", "a răspunde", "risc", "a se întreba", "încă",
  "academie", "ancient", "consiliu", "secol", "indiciu", "concert", "județ", "dicționar", "a exista", "plat",
  "domn", "ascuns", "poate", "ofițer", "original", "livră", "proces", "a publica", "teatru", "bogăție",
  "a aprecia", "disponibil", "a bate", "strălucitor", "a sărbători", "a determina", "a dispărea", "altceva", "corect", "flux",
  "înainte", "deal", "nivel", "singur", "baltă", "răspuns", "sezon", "soluție", "risipă", "dacă",
  "a se certa", "a comunica", "mulțime", "a depinde", "farfurie", "gol", "exact", "proaspăt", "a aduna", "a indica",
  "obiect", "ofertă", "preț", "produs", "proprietate", "achiziție", "a recomanda", "a selecta", "unealtă", "a trata",
  "viu", "os", "a deranja", "căpitan", "concluzie", "îndoială", "a explora", "străin", "bucuros", "totuși",
  "injustiție", "internațional", "avocat", "a menționa", "politică", "social", "discurs", "personal", "spre", "lemn",
  "a realiza", "a sfătui", "deja", "de bază", "un pic", "a considera", "a distruge", "a distra", "extra", "scop",
  "a minți", "carne", "opinie", "real", "a reflecta", "privire", "a servi", "legumă", "război", "merită",
  "a apărea", "bază", "creier", "carieră", "funcționar", "efort", "a intra", "excellent", "erou", "grabă", "a informa",
  "mai târziu", "a pleca", "a localiza", "asistentă", "operațiune", "durere", "a refuza", "deși", "variat",
  "actual", "a uimi", "taxă", "confort", "contact", "client", "a livra", "a câștiga", "poartă", "a include",
  "a gestiona", "mister", "a avea loc", "opus", "farfurie", "a primi", "recompensă", "a pune", "a fura", "hoț",
  "avans", "atlet", "medie", "comportament", "în spate", "curs", "mai jos", "meci", "membru", "mental",
  "pasager", "personalitate", "poem", "stâlp", "a elimina", "siguranță", "a trage", "sunet", "a înota", "pânză",
  "block", "cheer", "complex", "critic", "event", "exercițiu", "a se potrivi", "prietenie", "ghid", "lipsă",
  "pasaj", "a performa", "presiune", "probable", "public", "strike", "suport", "sarcină", "termen", "a uni",
  "a asocia", "environment", "factory", "feature", "instance", "involve", "medicine", "mix", "organize",
  ...
  // --- BOOK 2 ---
  "anxios", "groaznic", "a consta", "dorință", "dornic", "gospodărie", "intenție", "peisaj", "a ridica", "sarcină",
  "plămân", "mișcare", "ritm", "politicos", "a poseda", "rapid", "remarcă", "a căuta", "a străluci", "a vărsa",
  "a aduce", "castel", "comandă", "sfat", "a asigura", "explozie", "bijuterii", "pământ", "meteor", "monster",
  "nordic", "izolat", "sudic", "statue", "steam", "a trimite", "templu", "superior", "buruiană", "wing",
  "săgeată", "bătălie", "bow", "brave", "chief", "disadvantage", "enemy", "entrance", "hardly", "intend",
  ...
  // --- BOOK 3 ---
  "a apărea", "binefăcător", "fierar", "caritabil", "coș", "a compensa", "întâlnire", "a depăși", "a făuri",
  "umil", "fier", "scară", "modest", "a ocupa", "ban", "a predica", "a prospera", "provincie", "satisfacție", "a susține",
  "a dobândi", "stângaci", "îngrijitor", "a înșela", "a descuraja", "fals", "ură", "colibă", "inferior", "cabană", "a neglija",
  "nou-venit", "ofensă", "a trece cu vederea", "a răsplăti", "ridicol", "satisfăcător", "cioban", "a se aventura", "grâu",
  "alee", "ax", "buchet", "chore", "decent", "disgrație", "elbow", "grateful", "irritate", "kid", "loose", "offend",
  ...
  // --- BOOK 4 ---
  "aromă", "băutură", "grup", "a combina", "condensat", "contemporan", "a cultiva", "divin", "umed",
  "miros", "palat", "paradis", "plantație", "rapid", "rată", "calmant", "subtil", "textură", "toxic", "a varia",
  "accident", "amiral", "arc", "caracter", "conștiință", "înflăcărat", "carne", "grepfrut", "fân", "îngrozit",
  "kerosen", "buclă", "vâslă", "plută", "acru", "miză", "steward", "sfoară", "spin", "epuiză",
  "a avertiza", "audibil", "uimitor", "a se feri", "a se lăuda", "conștient", "dezacord", "ecou", "eventual", "indiciu",
  "idiot", "imens", "indirect", "opțiune", "trecut", "perfect", "a indica", "comutator", "temeinic", "chin",
  "cioc", "umed", "a dezaproba", "cu excepția", "zbor", "pasionat", "imoral", "iederă", "gemăt", "inconștient", "a pieri", "groapă",
  ...
  "betray", "blast", "bracelet", "cease", "choke", "civil", "comment", "cross", "dent", "distrust", "found",
  ...
  "aircraft", "celebrity", "concrete", "decisive", "esteemed", "ethical", "extinct", "hardy", "institute", "jealous",
  ...
  // --- BOOK 5 ---
  "a aloca", "a îngrozi", "depozit", "comoditate", "lipsă", "deliberat", "cumplit", "a trece", "empatie", "imaginar",
  "nemulțumire", "extenuant", "banal", "a opta", "ultraj", "derizoriu", "a rectifica", "descurcăreț", "susținere", "plictisitor",
  ...
  // --- BOOK 6 ---
  "a atenua", "astrologie", "a diferenția", "a întrerupe", "ecuație", "a greși", "eronat", "frenetic", "carena", "inadvertent", "a improviza",
